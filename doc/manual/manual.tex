...
\subtitle{A \LaTeX\ to \XML/\HTML/\MathML\ Converter;\\ \emph{\CurrentVersion}}
...
\begin{description}
 \item[html] both math and graphics are converted to png images;
    \code{LaTeXML-html.xslt} is used.
...
It binds a \ltxpod{Core::State} object (to \ltxcode|$STATE|) to maintain the current state
