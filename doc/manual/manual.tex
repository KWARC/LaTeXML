...
\lstdefinestyle{shell}{language=bash,escapechar=@,basicstyle=\ttfamily\iflatexml\else\small\fi,%
   morekeywords={latexml,latexmlpost,latexmlmath,latexmlc},
...
desired \XML, with extensions to allow substituting arguments or other data into the pattern.
In addition to literal replacement, the following may appear:
\begin{itemize}
